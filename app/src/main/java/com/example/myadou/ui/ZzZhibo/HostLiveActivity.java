...
import com.example.myadou.widet.HeightSensenableConstrantLayout;
...
public class HostLiveActivity extends Activity implements HostLiveContract.View, ILVLiveConfig.ILVLiveMsgListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hostactivityzz);
        //1.初始化消息的接受者
    ...
    private void initListener() {
        ...
        chatswitchlayout.setOnMsgSendListener(new BottomChatSwitchLayout.OnMsgSendListener() {
            ...
            public void sendMsg(String text) {
                ...
                sendTextMsg(text, sendserId, CustomTimProfileInfo.TEXT_MSG);
            }
            ...
            public void danmu(String text) {
                ...
                sendTextMsg(newText, sendserId, CustomTimProfileInfo.DANMU_MSG);
            }
        });
    }
    ...
    private void initView() {
        ...
        bottomswitchlayout = findViewById(R.id.bottomswitchlayouts);
        bottomswitchlayout.iv_switch_gift.setVisibility(View.INVISIBLE);
        chatswitchlayout = findViewById(R.id.chatswitchlayouts);
        //初始化listview
        lmlv = findViewById(R.id.lmlvs);
    ...
    public void onNewTextMsg(ILVText text, String SenderId, TIMUserProfile userProfile) {
        ...
        if (msg.startsWith(CustomTimProfileInfo.TYPE_DAN)) {
            ...
            //通过消息本体 拿到到底是哪个礼物
            String newMsg = msg.substring(CustomTimProfileInfo.TYPE_GIFT_REPEAT.length(), msg.length());
            //获取消息中的礼物信息
    ...
    private void sendGift() {
        ...
        if (firstSendTimeMillion == 0) {
            ...
            //如果属于连击的化 需要把倒计时在从10开始倒数  并且增加礼物数量
